...
**배포 중 전화가 끊기던 구간이 사라집니다.** 그리고 배포 사고 중 지표에 안 잡히던 둘을
시끄럽게 만듭니다.
...
- **시간은 두 값을 더하지 않습니다.** SIGTERM 부터 `shutdownDeadlineMs`(기본 110초) 하나를
  세고, 인계 대기가 쓴 만큼 드레이닝의 몫이 줄어듭니다. 더하면 플랫폼 유예를 넘깁니다.
